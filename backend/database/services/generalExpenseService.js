...
exports.generalExpenseService = exports.GeneralExpenseService = void 0;
const config_1 = require("../config");
class GeneralExpenseService {
    pool = (0, config_1.getPool)();
    async createGeneralExpense(data) {
    ...
    async getGeneralExpensesByProject(projectId) {
    ...
    async getGeneralExpenseById(expenseId) {
    ...
    async updateGeneralExpense(expenseId, data) {
    ...
    async deleteGeneralExpense(expenseId) {
    ...
    async getExpenseSummaryByProject(projectId) {
    ...
    async approveGeneralExpense(expenseId, approvedBy) {
        console.log('Approving general expense:', expenseId, 'by user:', approvedBy);
        const client = await this.pool.connect();
        try {
            await client.query('BEGIN');
            const expenseResult = await client.query('SELECT * FROM general_expenses WHERE id = $1', [expenseId]);
    ...
    async rejectGeneralExpense(expenseId) {
...
exports.GeneralExpenseService = GeneralExpenseService;
exports.generalExpenseService = new GeneralExpenseService();
//# sourceMappingURL=generalExpenseService.js.map